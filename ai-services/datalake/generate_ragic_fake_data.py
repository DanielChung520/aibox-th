...
def gen_vendors() -> list[dict]:
    ...
    for i in range(N_VENDOR):
        ...
        d = {
            ...
            "1015579": fake.company()[:20] if random.random() > 0.3 else None,
            "1015581": fake.bothify("########"),
            "1015582": fake.email(),
            "1015583": fake.phone_number()[:15],
            "1015584": fake.phone_number()[:15] if random.random() > 0.5 else None,
            "1015589": fake.name(),
            "1015590": f"www.{fake.domain_name()}" if random.random() > 0.5 else None,
            ...
            "1015606": fake.phone_number()[:15] if random.random() > 0.5 else None,
            "1015608": city,
            "1015609": district,
            "1015610": f"{city}{district}{fake.street_address()}",
            ...
            "1015647": fake.text(max_nb_chars=50) if random.random() > 0.7 else None,
            "1016116": fake.email(),
            "1016481": city,
            "1016482": district,
